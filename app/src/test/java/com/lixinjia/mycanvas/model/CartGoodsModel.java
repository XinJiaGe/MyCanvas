...
public class CartGoodsModel implements Serializable
{
	...
	public int getExtra_goods_type() {
		return extra_goods_type;
	}

	public void setExtra_goods_type(int extra_goods_type) {
		this.extra_goods_type = extra_goods_type;
	}

	private int extra_goods_type;
	// add
